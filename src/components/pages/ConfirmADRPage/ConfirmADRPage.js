...
export default (props) => {
  ...
  useEffect(() => {
    let fromStatus = "10";
    let toStatus = "10";
    dispatch(adrnumberActions.getADRNumberAccountant(fromStatus, toStatus));
            ...
            <Paper className={classes.paper}>
              ...
              <Grid container item xs={12} spacing={1}>
                ...
                <Grid item xs={12} md={4}>
                  <TextField
                    className={classes.margin}
                    disabled={create ? editdisable : false}
                    fullWidth
                    // required
                    error
                    size="small"
                    id="vAccRemark"
                    label="Remark for accountant"
                    placeholder="Remark for accountant"
                    variant="outlined"
                    value={adrhead.vAccRemark}
                    values={(values.vAccRemark = adrhead.vAccRemark)}
                    onChange={(event) => {
                      // console.log(event.target.value);
                      setADRHead({
                        ...adrhead,
                        vAccRemark: event.target.value,
                      });
                    }}
                    InputLabelProps={{ shrink: true }}
                    SelectProps={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <DialogContent>
            <Grid container item xs={12} spacing={2}>
              <Grid item xs={5}>
                <Autocomplete
                  ...
                  value={itemadrdetail.vItemDesc2}
                  values={(values.vItemNo = itemadrdetail.vItemNo)}
                  onChange={(event, values) => {
                    // console.log(values);
                    if (values) {
                      setItemADRDetail({
                        ...itemadrdetail,
                        vItemNo: values.FMASID,
                        vItemDesc1: values.FMFADS,
                        vItemDesc2: { ITEM: values.ITEM },
                        vSBNO: values.FMSBNO,
                        vItemCostcenter: values.FMAIT2,
                        vItemDate: values.FMPPER,
                        vAssetCost: values.FHCOST,
                        vNetValue: values.FHFAVA,
                        vItemQty: values.FMFAQT,
                        vItemDefaultQty: values.FMFAQT,
                        vItemPrice: "",
                        vItemRemark: "",
                      });
                    }
              ...
              <Grid item xs>
                <TextField
                  ...
                  label="Item Name"
                  type="text"
                  value={itemadrdetail.vItemDesc1}
                  values={(values.vItemDesc1 = itemadrdetail.vItemDesc1)}
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
            </Grid>
            ...
            <Grid container item xs={12} spacing={2}>
              <Grid item xs={1}>
                <TextField
                  ...
                  id="vSBNO"
                  label="SBNO"
                  value={itemadrdetail.vSBNO}
                  values={(values.vSBNO = itemadrdetail.vSBNO)}
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
              <Grid item xs={2}>
                <TextField
                  ...
                  id="vItemCostcenter"
                  label="Cost Center"
                  value={itemadrdetail.vItemCostcenter}
                  values={
                    (values.vItemCostcenter = itemadrdetail.vItemCostcenter)
                  }
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
              <Grid item xs={3}>
                <TextField
                  ...
                  label="Date"
                  type="date"
                  value={itemadrdetail.vItemDate}
                  values={(values.vItemDate = itemadrdetail.vItemDate)}
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
              ...
              <Grid item xs={3}>
                <TextField
                  ...
                  label="Asset Cost"
                  type="number"
                  value={itemadrdetail.vAssetCost}
                  values={(values.vAssetCost = itemadrdetail.vAssetCost)}
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
              ...
              <Grid item xs={3}>
                <TextField
                  ...
                  label="Net Value"
                  type="number"
                  value={itemadrdetail.vNetValue}
                  values={(values.vNetValue = itemadrdetail.vNetValue)}
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
            </Grid>
            ...
            <Grid container item xs={12} spacing={2}>
              <Grid item xs={6}>
                <TextField
                  ...
                  label="Qty"
                  type="number"
                  value={itemadrdetail.vItemQty}
                  values={(values.vItemQty = itemadrdetail.vItemQty)}
                  InputLabelProps={{ shrink: true }}
                  onChange={(event) => {
                    // console.log(event.target.value);
                    if (event.target.value <= itemadrdetail.vItemDefaultQty) {
                      setItemADRDetail({
                        ...itemadrdetail,
                        vItemQty: event.target.value,
                      });
                    }
                  }}
                  onInput={(e) => {
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  label="Price"
                  type="text"
                  value={itemadrdetail.vItemPrice}
                  values={(values.vItemPrice = itemadrdetail.vItemPrice)}
                  InputLabelProps={{ shrink: true }}
                  onChange={(event) => {
                    // console.log(event.target.value);
                    setItemADRDetail({
                      ...itemadrdetail,
                      vItemPrice: event.target.value,
                    });
                  }}
                  onInput={(e) => {
                    e.target.value = e.target.value.toString().slice(0, 15);
            ...
            <TextField
              ...
              label="Remark"
              type="text"
              value={itemadrdetail.vItemRemark}
              values={(values.vItemRemark = itemadrdetail.vItemRemark)}
              onChange={(event) => {
                // console.log(event.target.value);
                setItemADRDetail({
                  ...itemadrdetail,
                  vItemRemark: event.target.value,
                });
              }}
            />
            ...
            <TextField
              disabled={true}
              required={
                itemadrdetail.vItemLine === "" ? imagereqdisable : false
              }
              inputRef={inputRef}
              fullWidth
              id="vImage"
    ...
    <div className={classes.root}>
      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          formData.append("vAppRemark1", values.vAppRemark1);
          formData.append("vAppRemark2", values.vAppRemark2);
          formData.append("vAppRemark3", values.vAppRemark3);
          formData.append("vAppRemark4", values.vAppRemark4);
          ...
          if (values.vSubmit === "submit") {
            ...
            (async function() {
              ...
              let toStatus = "10";
              await dispatch(
                adrnumberActions.getADRNumberAccountant(fromStatus, toStatus)
              );
              handleClear();
          ...
          if (values.vSubmit === "reject") {
            ...
            (async function() {
              let data = await dispatch(adrheadActions.rejectADRHead(formData));
      ...
      >
        {(props) => showFormConfirm(props)}
      </Formik>

      {/* Detail Table */}
      {/* <p>#Debug Detail {JSON.stringify(itemadrdetail)}</p> */}
      {/* <p>#Debug File {JSON.stringify(file)}</p> */}
      <MaterialTable
        id="root_pr"
        title={`ADR Number : ${adrhead.vStatus}`}
        columns={columns}
        data={adrdetailReducer.result ? adrdetailReducer.result : []}
        // isLoading={adrdetailReducer.result ? false : true}
        components={{
          Toolbar: (props) => (
            <div>
              <MTableToolbar {...props} />
        ...
        //         dispatch(
        //           adrdetailActions.deleteADRDetail(
        //             adrhead.vADRNumber,
        //             item.ALLINE
        //           )
        //         );
        ...
        //         let toStatus = "05";
        //         dispatch(
        //           adrdetailActions.fetchADRDetail(
        //             adrhead.vADRNumber,
        //             fromStatus,
        //             toStatus
        //           )
            ...
            onClick: (event, rowData) => {
              ...
              setTimeout(() => {
                data.map((values) => {
                  setItemADRDetail({
                    ...itemadrdetail,
                    vItemNo: values.ALITNO,
                    vItemLine: values.ALLINE,
                    vItemDesc1: values.ALITDE,
                    vItemDesc2: { ITEM: values.ITEM },
                    vSBNO: values.ALSBNO,
                    vItemCostcenter: values.ALCOST,
                    vItemDate: values.ALDATE,
                    vAssetCost: values.ALACOS,
                    vNetValue: values.ALNETV,
                    vItemQty: values.ALQTY,
                    vItemPrice: values.ALPRIC,
                    vItemRemark: values.ALREM1,
                    vImagePreview2: values.IMAGE,
                    vSubmit: "update",
                  });
                });
              }, 500);
      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          if (imagereqdisable) {
            ...
            // formData.append(
            //   "vImageName",
            //   adrhead.vADRNumber + "_" + values.vItemLine + ".png"
            // );
          }
          ...
          if (values.vSubmit === "create") {
            (async function() {
              await dispatch(
                adrdetailActions.addADRDetail(formData, props.history)
              );
            ...
            (async function() {
              await dispatch(
                adrdetailActions.updateADRDetail(formData, props.history)
              );
