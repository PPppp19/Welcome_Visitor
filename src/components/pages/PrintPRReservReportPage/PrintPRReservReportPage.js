...
export default (props) => {
  ...
  useEffect(() => {
    ...
    let status = "92";
    dispatch(prnumberbuyerActions.getPRNumberReserv(status));
              ...
              <Grid container item xs={12} className={classes.margin}>
                <Grid item xs={12} sm={4} className={classes.margin}>
                  <Autocomplete
                    ...
                    onChange={(event, values) => {
                      ...
                      if (values) {
                        let getEPRNumberselect = values.PRNUMBER.toString().split(
                          "::"
                        );
                        let getPRnumber = getEPRNumberselect[0].trim();
                        let getSupplier = getEPRNumberselect[1].trim();
                        setPRNumber({
                          ...prnumber,
                          vPRSelectNumber: getPRnumber,
                          vPRSelectNumberLine: values.PRNUMBER,
                          vPRNumberDesc: { PRNUMBER: values.PRNUMBER },
                          vSupplierNo: getSupplier,
                        });
                      } else {
                ...
                <Grid className={classes.margin}>
                  <a
                    ...
                    }/br_api/api_report/viewreserv/${loginActions.getTokenCono()}/${loginActions.getTokenDivi()}/${
                      prnumber.vPRSelectNumber
                    }/${prnumber.vSupplierNo}`}
                    target="_blank"
